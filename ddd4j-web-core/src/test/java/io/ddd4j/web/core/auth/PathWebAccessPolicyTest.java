...
class PathWebAccessPolicyTest {
    ...
    void exactPatternMatchesOnlyExactPath() {
        PathWebAccessPolicy policy = new PathWebAccessPolicy(java.util.Arrays.asList("/health"), AuthenticationMode.REQUIRED);
    ...
    void constructorRejectsNull() {
        ...
        assertThrows(NullPointerException.class,
                () -> new PathWebAccessPolicy(java.util.Arrays.asList("/health"), null));
    }

    @Test
    void emptyPatternsDisableNothing() {
        PathWebAccessPolicy policy = new PathWebAccessPolicy(java.util.Arrays.asList(), AuthenticationMode.DISABLED);
