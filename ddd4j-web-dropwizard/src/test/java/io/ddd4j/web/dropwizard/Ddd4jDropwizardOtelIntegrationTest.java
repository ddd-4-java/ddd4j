...
/**
 * 验证 ddd4j-web-dropwizard 模块可与 WebOtelIntegration 集成。
 *
 * @author <a href="https://github.com/partme-ai">PartMe.AI</a>
 */
class Ddd4jDropwizardOtelIntegrationTest {

    @Test
    void dropwizardModuleCanUseWebOtelIntegration() {
        Object span = WebOtelIntegration.startServerSpan("GET", "/api/test", new HashMap<>());
        assertThat(span).isNotNull();
    }

    @Test
    void dropwizardModuleCanUseWebOtelIntegration_withTraceparent() {
