...
/**
 * Vert.x 运行时 CQRS 契约测试。
 * <p>
 * 使用 core 组件纯装配方式（无 DI 容器，直接 new），与模块现有 {@code Ddd4jVertxRuntimeTest} 风格一致。
 * Vert.x 模块目前无框架级 CQRS 适配器，本测试证明该运行时能承载 core CQRS 组件。
 * <p>
 * 装配方式：
 * <ul>
 ...
 * @since 3.0.0
 */
class VertxCqrsRuntimeContractTest extends AbstractCqrsRuntimeContractTest {
