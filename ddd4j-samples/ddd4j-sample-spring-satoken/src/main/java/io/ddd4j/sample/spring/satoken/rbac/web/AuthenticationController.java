package io.ddd4j.sample.spring.satoken.rbac.web;
 ...
 *
 * <p>本控制器演示 Sa-Token 注解式鉴权（{@code @SaCheckLogin} / {@code @SaCheckRole} /
 * {@code @SaCheckPermission}），结合 {@link RbacService} 通过 ddd4j SubjectKit 实现业务侧鉴权判断。
 *
 * <h3>3 种鉴权控制</h3>
 * <ol>
 *   <li><b>登录鉴权</b>：{@code @SaCheckLogin}，仅登录用户可访问</li>
 *   <li><b>角色鉴权</b>：{@code @SaCheckRole("admin")}，指定角色可访问</li>
 *   <li><b>权限鉴权</b>：{@code @SaCheckPermission("user:delete")}，拥有权限可访问</li>
 * </ol>
 *
