package io.ddd4j.sample.spring.satoken.order.application;
...
import io.ddd4j.sample.spring.satoken.order.domain.service.OrderDomainService;
 ...
 *   <li>触发 ddd4j 领域事件发布（通过 {@code SpringDomainEventPublisher} 桥接）</li>
 * </ul>
 *
