 ...
 *
 * <p>本 sample 的路由在 ApiBuilder.path("orders", ...) 下，OrderResource 内部又使用 /orders 前缀，
...
class OrderResourceTest {
    ...
    void pay_paidOrderTwice_secondShouldFail() throws Exception {
        ...
        HttpResponse<String> r2 = postJson("/orders/orders/" + id + "/pay", "");
    ...
    void ship_shippedOrderTwice_shouldFail() throws Exception {
        ...
        HttpResponse<String> r2 = postJson("/orders/orders/" + id + "/ship", "");
        assertTrue(r2.statusCode() >= 400);
    }
    ...
    void cancel_cancelledOrderTwice_shouldNotConflict() throws Exception {
        ...
        String id = extractId(create.body());
        postJson("/orders/orders/" + id + "/cancel", "");
        HttpResponse<String> r2 = postJson("/orders/orders/" + id + "/cancel", "");
