...
import io.ddd4j.sample.javalin.goods.domain.GoodsQuery;
 ...
 *
 * <p>特点（与第二轨 OrderRepository 对比）：
 * <ul>
 *   <li><b>无 Model/PO 分离</b>：Goods 本身就是 PO，没有 OrderPO/OrderLinePO</li>
 *   <li><b>无 DomainObjectMapper</b>：仓储直接操作 Goods，无映射开销</li>
 *   <li><b>实现 RichRepository</b>：让 GoodsQuery 的充血查询方法可用</li>
 * </ul>
 *
