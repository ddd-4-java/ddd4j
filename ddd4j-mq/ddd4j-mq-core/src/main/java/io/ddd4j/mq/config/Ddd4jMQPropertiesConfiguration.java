...
/**
 * Framework 版 MQ 属性与通用 Bean 配置（无 Spring Boot 依赖）。
 * <p>
 * 供 base 扩展模块 Testcontainers 集成测试及纯 Spring {@code @Configuration} 装配使用。
 */
...
public class Ddd4jMQPropertiesConfiguration {
     ...
     *
     * @param environment Spring 环境（含 {@code @DynamicPropertySource} 注入项）
     * @return MQ 主配置
     */
    @Bean
