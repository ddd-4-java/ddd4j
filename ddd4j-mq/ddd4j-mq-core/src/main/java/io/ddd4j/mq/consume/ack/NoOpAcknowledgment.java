 ...
 */
@Slf4j
public class NoOpAcknowledgment implements Acknowledgment {

    /**
     * 单例占位确认器（无 Broker 场景）。
     */
    public static final NoOpAcknowledgment INSTANCE = new NoOpAcknowledgment();
     ...
     * @param context 确认上下文
     */
    public NoOpAcknowledgment(AcknowledgmentContext context) {
    ...
    private void markAcknowledged(String operation) {
        if (acknowledged.compareAndSet(false, true)) {
            log.debug("NoOpAcknowledgment: {}", operation);
        }
    }
}
