 ...
 */
public final class MQDestinationResolver {

    private MQDestinationResolver() {
    }
     ...
     * @param props  MQ 配置
     */
    public static void fillDefaults(MQEvent event, Ddd4jMQProperties props) {
     ...
     * @return 物理地址字符串
     */
    public static String resolvePhysicalAddress(MQEvent event, MQDestination destination, Ddd4jMQProperties props) {
