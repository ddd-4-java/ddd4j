...
public final class RedisStreamMessageAcknowledgmentFactory {
    ...
    public static Optional<RedisStreamMessageAcknowledgment> from(
        ...
        Objects.requireNonNull(message, "message");
        Objects.requireNonNull(stringRedisTemplate, "stringRedisTemplate");
        Object streamKeyHeader = message.getHeaders().get(RedisStreamMessageAcknowledgment.HEADER_STREAM_KEY);
        Object groupHeader = message.getHeaders().get(RedisStreamMessageAcknowledgment.HEADER_CONSUMER_GROUP);
        Object recordIdHeader = message.getHeaders().get(RedisStreamMessageAcknowledgment.HEADER_RECORD_ID);
