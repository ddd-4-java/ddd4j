...
if [[ ${AGGREGATE_RC} -ne 0 ]]; then
  ...
  CORE_MODULES=(
    ...
    "ddd4j-runtime/ddd4j-runtime-core" "ddd4j-runtime/ddd4j-runtime-spring" "ddd4j-runtime/ddd4j-runtime-vertx" "ddd4j-runtime/ddd4j-runtime-helidon" "ddd4j-runtime/ddd4j-runtime-micronaut" "ddd4j-runtime/ddd4j-runtime-dropwizard"
