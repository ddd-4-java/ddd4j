...
/**
 * 独立验证器：验证 ddd4j-adapter-spring 的 DDD 注解与 Spring 元注解融合正确。
 */
@Slf4j
public final class AnnotationFusionVerifier {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.error("FAIL: @DomainEvent 不应在 ddd4j-adapter-spring 中");
            failed++;
        } catch (ClassNotFoundException ex) {
            log.info("PASS: @DomainEvent 不在 ddd4j-adapter-spring");
            passed++;
        }
        ...
        log.info("全部验证通过，ddd4j-adapter-spring 注解收敛完成");
    }
