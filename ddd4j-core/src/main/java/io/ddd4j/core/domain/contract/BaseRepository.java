 ...
 *
 * @param <M> 聚合根/模型类型，需继承 {@link Model}
 * @param <Q> 查询条件类型，需继承 {@link Query}
 * @author <a href="https://github.com/partme-ai">PartMe.AI</a>
 * @deprecated 3.0.0 起迁移至 {@link io.ddd4j.core.domain.repository.Repository}，
 *             由 Spring/Quarkus/Guice 容器注入（替代静态注册表机制）。
 *             本接口保留完整方法签名供 ddd4j-data-mybatis 等 1.x 兼容层使用，
 *             将在 4.0.0 移除。
 */
@Deprecated
