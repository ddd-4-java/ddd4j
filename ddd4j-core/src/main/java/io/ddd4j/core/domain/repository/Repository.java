 ...
 * 取代以下三个历史接口：
 * <ul>
 *   <li>{@code io.ddd4j.core.domain.contract.BaseRepository}（ActiveRecord CRUD + 静态注册表）</li>
 *   <li>{@code io.ddd4j.core.domain.repository.Repository}（Optional 风格）</li>
 *   <li>{@code io.ddd4j.core.domain.model.DomainObjectMapper}（含 delete/existsById 默认方法）</li>
 * </ul>
 *
 * <h3>设计原则</h3>
 * <ul>
